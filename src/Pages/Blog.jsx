      ...
      <div className="max-w-2xl px-6 py-16 mx-auto space-y-12">
        <article className="space-y-8  dark:text-gray-900">
          <div className="space-y-6">
            ...
            <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center dark:text-gray-600">
              ...
              <p className="flex-shrink-0 mt-3 text-sm md:mt-0">
                {public_reactions_count} comments • {positive_reactions_count}{" "}
                views
              </p>
            </div>
          </div>
          ...
          onClick={()=>setTabIndex(1)}
              className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2  dark:border-gray-300${tabIndex ===1?'  border border-b-0':'border-b'  } dark:text-gray-600`}
